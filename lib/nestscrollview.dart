...
class NestScrollView extends StatefulWidget {
  NestScrollView({Key? key}) : super(key: key);

  @override
  _NestScrollViewState createState() => new _NestScrollViewState();
}
...
class _NestScrollViewState extends State<NestScrollView> {
  ...
  Future _loadMoreVertical() async {
    Fluttertoast.showToast(msg: "bottom vertical");
    setState(() {
  ...
  Future _loadMoreHorizontal() async {
    Fluttertoast.showToast(msg: "bottom horizontal");
    setState(() {
